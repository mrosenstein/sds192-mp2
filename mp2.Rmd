...
# Replace abbreviated state names in our dataframe to full state names
...
=======
Because the republican party revealed to receive the most contributions, the following visualization displays the distribution of contributions from every state to republican party.The contributions highlighted in this visualzation are only contributions from organizations. In the data visualzation of the republican party, Maryland clearly received the most contributions in 2012. 
>>>>>>> 4e296a7dc37c4c2704a0f6af492e0fdf8ec1cea5
